...
HTML_FILE = "player_v6.html" # 產出的網頁檔名
# ========================================
...
<head>
    ...
    <style>
        ...
        /* 播放清單 */
        .playlist-container {{ padding: 20px; padding-bottom: 350px; /* 底部留白 */ }}
...
<body>
    ...
    <script>
        ...
        function loadTrack(index) {{
            ...
            displaySentenceTrans.innerText = item.sentence_trans || ""; // 新增這行
            ...
            if(activeItem) {{
                ...
                // 計算目標捲動位置 = 元素絕對位置 - (視窗高度 * 0.75) => 位於下方1/4處
    ...
    print(f"✅ V6 網頁已生成！請開啟 {HTML_FILE}")
